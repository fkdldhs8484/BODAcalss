        ...
        <div class="alert">
            <div class="modal">
                ...
                <div class="modalBox">
                    ...
                    $regTime = time(); // $youID = $connect -> real_escape_string(trim($youID)); // $youName = $connect -> real_escape_string(trim($youName)); // $youPass = $connect -> real_escape_string(trim($youPass)); // $youNickName = $connect -> real_escape_string(trim($youNickName)); // $youEmail = $connect -> real_escape_string(trim($youEmail)); // $youBirth = $connect -> real_escape_string(trim($youBirth)); // $youPhone = $connect -> real_escape_string(trim($youPhone)); // $youPass = sha1("web".$youPass);
                    // 회원가입
